               ...
               (new %Deal_obj_map
                (seq
                 (seq
                  ...
                  (ap ("timestamp" "2024-03-16T11:03:34.316Z") %Deal_obj_map)
                 )
                ...
                (seq
                 (seq
                  (seq
                   ...
                   (ap ("definition" "bafkreieyhrkqht6x7y7tspq7dboy2xd57whjcenrtcfgcdqsdeyzllo2ry") %Deal_obj-0_map)
                  )
                  (ap ("timestamp" "2024-03-16T11:03:30.169Z") %Deal_obj-0_map)
                 )
               ...
               (seq
                (seq
                 (seq
                  ...
                  (ap ("definition" "bafkreibgmy3vpq6xcfqwsqmecmihmk5aw3rhmgjfswtw4tyw5pzn34mp6u") %Deal_obj-1_map)
                 )
                 (ap ("timestamp" "2024-03-16T11:08:19.395Z") %Deal_obj-1_map)
                )
                      ...
                      (new %Deal_obj-2_map
                       (seq
                        (seq
                         ...
                         (ap ("timestamp" "2024-03-16T11:03:34.316Z") %Deal_obj-2_map)
                        )
                       ...
                       (seq
                        (seq
                         (seq
                          ...
                          (ap ("definition" "bafkreieyhrkqht6x7y7tspq7dboy2xd57whjcenrtcfgcdqsdeyzllo2ry") %Deal_obj-3_map)
                         )
                         (ap ("timestamp" "2024-03-16T11:03:30.169Z") %Deal_obj-3_map)
                        )
                      ...
                      (seq
                       (seq
                        (seq
                         ...
                         (ap ("definition" "bafkreibgmy3vpq6xcfqwsqmecmihmk5aw3rhmgjfswtw4tyw5pzn34mp6u") %Deal_obj-4_map)
                        )
                        (ap ("timestamp" "2024-03-16T11:08:19.395Z") %Deal_obj-4_map)
                       )
           ...
           (seq
            (seq
             (seq
              ...
              (canon ret-3_flat.$.[0].worker_id.[0] $ret  #push-to-stream-195)
             )
             (ap #push-to-stream-195 $queue)
            )
            (new $-ephemeral-stream-
             (new #-ephemeral-canon-
              (canon ret-3_flat.$.[0].host_id $-ephemeral-stream-  #-ephemeral-canon-)
